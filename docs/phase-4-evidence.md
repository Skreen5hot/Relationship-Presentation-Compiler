...
Stages 01–03 while retaining the Phase 4 host contract.
...
- SHA-256: `0c053f2931455a3656324aac7774f408ac440f64dfa75651f8923c015ee5dad0`
- SRI: `sha384-bl3pYUth05cLKCVGlLYb2S9e0If+FtRV+sgeARcX0w2oTFC4g90fLYUvPPZ+k3V+`
...
profile, context, contract, and contamination cases. The canonical request now
passes C3–C6 and Stages 01–03, then returns `INTERNAL_COMPILER_ERROR` at the
explicit Stage 04 boundary; equivalence asserts identical bytes and codes, not
full semantic success that has not yet been implemented.
